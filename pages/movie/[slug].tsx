...
export default function MoviePage({movie, similarMovies }: MovieData) {
    return (
        <div style={{ backgroundImage: `url(https://image.tmdb.org/t/p/w500/${movie.backdrop_path}) no-repeat fixed` }}>
            <Head>
            ...
            <main>
                ...
                <section>
                    ...
                    {similarMovies.map((movie) => {
                        return (
                            <Movie id={movie.id} image={`https://image.tmdb.org/t/p/w500/${movie.poster_path}`} />
                        )
                    })}
                </section>
            </main>
